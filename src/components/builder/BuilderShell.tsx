...
export function BuilderShell() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-4 py-6 lg:flex-row lg:px-6">
      ...
      <main className="min-w-0 flex-1">
        {loadError ? (
          ...
          >
            Your saved draft could not be opened: {loadError} Starting a new one — nothing has been
            overwritten yet.
          </div>
        ) : null}
        ...
        <header className="mb-5 flex flex-wrap items-start justify-between gap-3">
          <div>
            <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">{step.label}</h1>
