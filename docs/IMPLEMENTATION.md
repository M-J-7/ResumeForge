...
| Page titles: `"Privacy — Six Seconds Resume"`, `/^Six Seconds Resume — free downloads/`                                                                                                                                                                                                                                                                                                             | `e2e/builder.spec.ts`                        |
...
7. ~~**No name, no brand, no trust signals.**~~ **Closed 2026-09-10.** `PRODUCT_NAME` is `"Six Seconds Resume"` — named for the six seconds a recruiter spends before deciding, which is the argument the whole layout already makes. The trust signals shipped with P37.
